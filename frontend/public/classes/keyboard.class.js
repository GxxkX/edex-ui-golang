// Wails 版本的键盘类
// 从 Electron keyboard.class.js 转换而来
...
class Keyboard {
    constructor(opts) {
        ...
        // 异步加载键盘布局
        this.loadLayout(opts.layout);
    }

    // 异步加载键盘布局文件
    async loadLayout(layoutPath) {
        try {
            // 在 Wails 中，资源文件通过 HTTP 请求加载
            const response = await fetch(layoutPath);
            if (!response.ok) {
                throw new Error(`Failed to load keyboard layout: ${response.status}`);
            }
            const layout = await response.json();
            
            // 解析键盘布局并创建 DOM
            this.createKeyboardDOM(layout);
        } catch (error) {
    ...
    createDefaultKeyboard() {
        this.container.innerHTML = `
            <div class="keyboard_row" id="row1">
                <div class="keyboard_key" data-cmd="1">1</div>
                <div class="keyboard_key" data-cmd="2">2</div>
                <div class="keyboard_key" data-cmd="3">3</div>
                <div class="keyboard_key" data-cmd="4">4</div>
                <div class="keyboard_key" data-cmd="5">5</div>
                <div class="keyboard_key" data-cmd="6">6</div>
                <div class="keyboard_key" data-cmd="7">7</div>
                <div class="keyboard_key" data-cmd="8">8</div>
                <div class="keyboard_key" data-cmd="9">9</div>
                <div class="keyboard_key" data-cmd="0">0</div>
            </div>
            <div class="keyboard_row" id="row2">
                <div class="keyboard_key" data-cmd="q">Q</div>
                <div class="keyboard_key" data-cmd="w">W</div>
                <div class="keyboard_key" data-cmd="e">E</div>
                <div class="keyboard_key" data-cmd="r">R</div>
                <div class="keyboard_key" data-cmd="t">T</div>
                <div class="keyboard_key" data-cmd="y">Y</div>
                <div class="keyboard_key" data-cmd="u">U</div>
                <div class="keyboard_key" data-cmd="i">I</div>
                <div class="keyboard_key" data-cmd="o">O</div>
                <div class="keyboard_key" data-cmd="p">P</div>
            </div>
            <div class="keyboard_row" id="row3">
                <div class="keyboard_key" data-cmd="a">A</div>
                <div class="keyboard_key" data-cmd="s">S</div>
                <div class="keyboard_key" data-cmd="d">D</div>
                <div class="keyboard_key" data-cmd="f">F</div>
                <div class="keyboard_key" data-cmd="g">G</div>
                <div class="keyboard_key" data-cmd="h">H</div>
                <div class="keyboard_key" data-cmd="j">J</div>
                <div class="keyboard_key" data-cmd="k">K</div>
                <div class="keyboard_key" data-cmd="l">L</div>
            </div>
            <div class="keyboard_row" id="row4">
                <div class="keyboard_key" data-cmd="z">Z</div>
                <div class="keyboard_key" data-cmd="x">X</div>
                <div class="keyboard_key" data-cmd="c">C</div>
                <div class="keyboard_key" data-cmd="v">V</div>
                <div class="keyboard_key" data-cmd="b">B</div>
                <div class="keyboard_key" data-cmd="n">N</div>
                <div class="keyboard_key" data-cmd="m">M</div>
                <div class="keyboard_key keyboard_enter" data-cmd="\r">Enter</div>
            </div>
            <div class="keyboard_row" id="row5">
                <div class="keyboard_key" id="keyboard_spacebar" data-cmd=" ">Space</div>
            </div>
        `;
    ...
    bindEventHandlers() {
                    ...
                    key.onmousedown = e => {
                        ...
                        if (window.keyboard.linkedToTerm) {
                            if (window.terminalManager) {
                                ...
                                window.term[window.currentTerm].focus();
                            }
                        }
                        if (this.container.dataset.passwordMode == "false" && window.audioManager)
        ...
        document.onkeyup = e => {
            ...
            if(this.container.dataset.passwordMode == "false" && e.key === "Enter" && window.audioManager)
                window.audioManager.granted.play();
        };
    ...
    pressKey(key) {
        ...
        if (shortcutsCat.length > 1) {
            this._shortcuts[shortcutsCat].forEach(cut => {
                ...
                if (cut.type === "app") {
                    ...
                    let fn = (cut.linebreak) ? writeln : write;
                    if (window.terminalManager) {
                        if (fn === 'write') {
                            window.terminalManager.write(window.currentTerm, cut.action);
                        } else if (fn === 'writeln') {
                            window.terminalManager.writeln(window.currentTerm, cut.action);
                        }
                    } else if (window.term[window.currentTerm]) {
        ...
        if (cmd === "\n") {
            if (window.keyboard.linkedToTerm) {
                if (window.terminalManager) {
                    window.terminalManager.writeln(window.currentTerm, "");
                } else if (window.term[window.currentTerm]) {
                    window.term[window.currentTerm].writeln("");
                }
            } else {
        ...
        if (window.keyboard.linkedToTerm) {
            if (window.terminalManager) {
                window.terminalManager.write(window.currentTerm, cmd);
            } else if (window.term[window.currentTerm]) {
